...
class MyApps:
  def __init__(self):
    self.my_apps_as_dict = anvil.server.call('get_my_apps_as_dicts', anvil.users.get_user())
...
#   my_apps_as_dict = anvil.server.call('get_my_apps_as_dicts', anvil.users.get_user())
